...
setwd("~/files/PAT_SingleTrials/AC25ROS161_2017_Jul_20_1431")
# read in PAT results
##change subject file name
PAT_AC25ROS161 <- read.csv("~/files/PAT_SingleTrials/AC25ROS161_2017_Jul_20_1431/Absolute Pitch Experiment.csv")
target.note<-PAT_AC25ROS161$target.note #insert correct PAT file
...
for (i in seq_along(data_list)) {
  ...
  #plot(freqWav)
  #plot(noteWav)
  entered<-as.numeric(PAT_AC25ROS161[i,4]) #table
  label<-PAT_AC25ROS161[i,6] #table
  target<-PAT_AC25ROS161$target.note # column name sometimes changes depending on type of read in...
...
AC25ROS161_sound_list<-sound_list
