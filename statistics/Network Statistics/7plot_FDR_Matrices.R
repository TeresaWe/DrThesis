...
library(ggplot2)
electrode_position<-read.csv("~/files/EEG Statistics/electrode_positions.csv", header=FALSE)
...
FDR_beta<-read.csv("~/files/EEG Statistics/zGraph Theory/single_connection_test/FDR_beta.csv", header=FALSE)
outP_beta<-read.csv("~/files/EEG Statistics/zGraph Theory/single_connection_test/outP_beta.csv", header=FALSE)
p_fdr_beta<-read.csv("~/files/EEG Statistics/zGraph Theory/single_connection_test/p_fdr_beta.csv", header=FALSE)
outD_beta<-read.csv("~/files/EEG Statistics/zGraph Theory/single_connection_test/outD_beta.csv", header=FALSE)
...
FDR_delta<-read.csv("~/files/EEG Statistics/zGraph Theory/single_connection_test/FDR_delta.csv", header=FALSE)
outP_delta<-read.csv("~/files/EEG Statistics/zGraph Theory/single_connection_test/outP_delta.csv", header=FALSE)
p_fdr_delta<-read.csv("~/files/EEG Statistics/zGraph Theory/single_connection_test/p_fdr_delta.csv", header=FALSE)
outD_delta<-read.csv("~/files/EEG Statistics/zGraph Theory/single_connection_test/outD_delta.csv", header=FALSE)
...
FDR_beta_z<-read.csv("~/files/EEG Statistics/zGraph Theory/single_connection_test/FDR_beta_z.csv", header=FALSE)
outP_beta_z<-read.csv("~/files/EEG Statistics/zGraph Theory/single_connection_test/outP_beta_z.csv", header=FALSE)
p_fdr_beta_z<-read.csv("~/files/EEG Statistics/zGraph Theory/single_connection_test/p_fdr_beta_z.csv", header=FALSE)
outD_beta_z<-read.csv("~/files/EEG Statistics/zGraph Theory/single_connection_test/outD_beta_z.csv", header=FALSE)
...
FDR_delta_z<-read.csv("~/files/EEG Statistics/zGraph Theory/single_connection_test/FDR_delta_z.csv", header=FALSE)
outP_delta_z<-read.csv("~/files/EEG Statistics/zGraph Theory/single_connection_test/outP_delta_z.csv", header=FALSE)
p_fdr_delta_z<-read.csv("~/files/EEG Statistics/zGraph Theory/single_connection_test/p_fdr_delta_z.csv", header=FALSE)
outD_delta_z<-read.csv("~/files/EEG Statistics/zGraph Theory/single_connection_test/outD_delta_z.csv", header=FALSE)
