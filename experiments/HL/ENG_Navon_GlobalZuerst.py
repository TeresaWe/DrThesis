...
This experiment was created using PsychoPy2 Experiment Builder (v1.84.2),
    on Di 16 Mai 2017 18:00:37 CEST
...
main_globinstr = visual.TextStim(win=win, name='main_globinstr',
    #text=u'Bitte reagieren Sie in der folgenden Aufgabe auf die \xfcbergeordnete, d.h. globale Form der Buchstaben, also den großen Buchstaben. Dieser gro\xdfe Buchstabe kann entweder H oder S sein. Bitte dr\xfccken Sie so schnell es geht die entsprechende Taste (Links="S" oder Rechts= "H").\n\nBeispiel:\n\n\n\n\n\n\n\n\n           Bsp: Rechte Taste dr\xfccken                                        Bsp: Linke Taste dr\xfccken\n\nDie Stimuli werden nur f\xfcr eine kurze Zeit pr\xe4sentiert. Bitte versuchen Sie so schnell es geht zu antworten, jedoch m\xf6glichst wenig Fehler zu machen.\n\nEs folgt nun eine kurze \xdcbung! ',
...
foot_globreal = visual.TextStim(win=win, name='foot_globreal',
    ...
    text=u'Press the green key to start with the experiment!',
    font='Arial',
    pos=(0, -0.9), height=0.04, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1,
    depth=-2.0);
...
for thisGlobal_block in global_block:
    ...
    for thisPractice_global in practice_global:
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            if t >= 2.5 and KeyG.status == NOT_STARTED:
            	...
            	KeyG.status = STARTED
            	# keyboard checking is just starting
            	win.callOnFlip(KeyG.clock.reset)  
    ...
    exp_global_1 = data.TrialHandler(nReps=1, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions(u'conditions_global_Navon_Part1.csv'),
    ...
    continueRoutine = True
    # update component parameters for each repeat
    #main_feedbackG.setText(u'Dr\xfccken Sie grüne Taste wenn Sie bereit sind, mit dem Test fortzuf\xfchren.')
    main_feedbackG.setText(u'Press the green key when you are ready to continue with the experiment.')
    ...
    # completed 1 repeats of 'exp_global_2'
...
for thisLocal_block in local_block:
    ...
    continueRoutine = True
    # update component parameters for each repeat
    #main_feedbackL.setText(u'Dr\xfccken Sie grüne Taste wenn Sie bereit sind, mit dem Test fortzuf\xfchren.')
    main_feedbackL.setText(u'Press the green key when you are ready to continue with the experiment.')
    ...
    # completed 1 repeats of 'exp_local_2'
